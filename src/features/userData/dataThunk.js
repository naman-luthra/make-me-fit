...
export const submitBasicInfo = createAsyncThunk(
    ...
    async ({ dob, gender, weight, height, diet, activity, weightGoal, activityGoal  }, {getState} ) => {
        try {
            ...
            await fetch('https://make-me-fit-backend.onrender.com/api/submit-user-info',{
                method: "post",
                headers: { 
...
export const getUserData = createAsyncThunk(
    ...
    async ( _ , {getState} ) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            const response  = await fetch('https://make-me-fit-backend.onrender.com/api/get-user-data',{
                method: "post",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
...
export const creatMealPlan = createAsyncThunk(
    ...
    async ({regenerate, plan, mealPlanName, cuisine, place, breakfast, lunch, dinner, snacks}, {getState}) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            const response = await fetch('https://make-me-fit-backend.onrender.com/api/create-meal-plan',{
                method: "post",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
...
export const createWorkoutRoutine = createAsyncThunk(
    ...
    async ({regenerate, plan, workoutRoutineName, goal, equipment}, {getState}) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            const response = await fetch('https://make-me-fit-backend.onrender.com/api/create-workout-routine',{
                method: "post",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
...
export const createFitnessPlan = createAsyncThunk(
    ...
    async ({planName}, {getState}) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            const response = await fetch('https://make-me-fit-backend.onrender.com/api/create-fitness-plan',{
                method: "post",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
...
export const setUserImage = createAsyncThunk(
    ...
    async ({image}, {getState}) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            await fetch('https://make-me-fit-backend.onrender.com/api/upload-user-image',{
                method: "post",
                headers:  {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
...
export const updateUserMetrics = createAsyncThunk(
    ...
    async ({weight, height, weightGoal, gender}, {getState}) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            await fetch('https://make-me-fit-backend.onrender.com/api/update-user-metrics',{
                method: "post",
                headers:  {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
...
export const getPlanData = createAsyncThunk(
    ...
    async ({planId}, {getState}) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            const response = await fetch('https://make-me-fit-backend.onrender.com/api/get-plan-data',{
                method: "post",
                headers:  {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
...
export const saveUserProgress = createAsyncThunk(
    ...
    async ({weight,water,food,excercise}, {getState}) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            await fetch('https://make-me-fit-backend.onrender.com/api/save-user-progress',{
                method: "post",
                headers:  {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
...
export const getUserHistory = createAsyncThunk(
    ...
    async (_, {getState}) => {
        try {
            ...
            const body=JSON.stringify(reqObject);
            const response = await fetch('https://make-me-fit-backend.onrender.com/api/get-user-history',{
                method: "post",
                headers:  {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${getState().auth.JWT}`
